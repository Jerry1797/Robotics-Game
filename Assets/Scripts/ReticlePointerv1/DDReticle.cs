...
public class DDReticle : GvrBasePointer
{
    ...
    public override void OnPointerClickDown() {
        //Jason
        ExecuteEvents.Execute(gazedAt, null, (DropDrag handler, BaseEventData data) => handler.HandleGazeTriggerStart());
    }
    ...
    public override void OnPointerClickUp() {
        //Jason
        ExecuteEvents.Execute(gazedAt, null, (DropDrag handler, BaseEventData data) => handler.HandleGazeTriggerEnd());
